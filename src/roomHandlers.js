...
function registerRoomHandlers(io, socket) {
  ...
  socket.on('room:create', ({ name, avatar, theme, customWords, customThemeName, maxPlayers }, callback) => {
    try {
      ...
      console.log(`[Room] ${name} a créé la salle ${room.code} (thème: ${room.theme})`);
